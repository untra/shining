...
class MyScene extends Phaser.Scene {
  ...
  create () {
    const logo1 = this.add.image(400, 300, 'sonic');
...
function create () {
  ...
  logo1 = game.add.sprite(0, 0, 'sonic');
  logo1.fixedToCamera = true;
  logo1.cameraOffset.setTo(100, 100);

  logo2 = game.add.sprite(0, 0, 'sonic');
  logo2.fixedToCamera = true;
  logo2.cameraOffset.setTo(500, 100);


  const t = game.add.text(0, 0, 'this text is fixed to the camera', { font: '32px Arial', fill: '#ffffff', align: 'center' });
