...
#    - team spd + 10%
    ...
    %{id: 1031, name: "Fire Staff 1", value: 1, type: :weapon, specifically: %{kind: :weapon_staff, atk: 4,  range: 1, elem: :elem_fire }},
    %{id: 1032, name: "Fire Staff 2", value: 2, type: :weapon, specifically: %{kind: :weapon_staff, atk: 5,  range: 1, elem: :elem_fire }},
    %{id: 1033, name: "Fire Staff 3", value: 3, type: :weapon, specifically: %{kind: :weapon_staff, atk: 6,  range: 3, elem: :elem_fire }},
    %{id: 1034, name: "Fire Staff 4", value: 4, type: :weapon, specifically: %{kind: :weapon_staff, atk: 8,  range: 4, elem: :elem_fire }},
    %{id: 1035, name: "Fire Staff 5", value: 5, type: :weapon, specifically: %{kind: :weapon_staff, atk: 12, range: 4, elem: :elem_fire }},
    %{id: 1031, name: "Ice Staff 1", value: 1, type: :weapon, specifically: %{kind: :weapon_staff, atk: 2,  range: 1, elem: :elem_ice }},
    %{id: 1032, name: "Ice Staff 2", value: 2, type: :weapon, specifically: %{kind: :weapon_staff, atk: 6,  range: 1, elem: :elem_ice }},
    %{id: 1033, name: "Ice Staff 3", value: 3, type: :weapon, specifically: %{kind: :weapon_staff, atk: 7,  range: 2, elem: :elem_ice }},
    %{id: 1034, name: "Ice Staff 4", value: 4, type: :weapon, specifically: %{kind: :weapon_staff, atk: 9,  range: 3, elem: :elem_ice }},
    %{id: 1035, name: "Ice Staff 5", value: 5, type: :weapon, specifically: %{kind: :weapon_staff, atk: 13, range: 4, elem: :elem_ice }},
    %{id: 1031, name: "Lightning Staff 1", value: 1, type: :weapon, specifically: %{kind: :weapon_staff, atk: 3,  range: 1, elem: :elem_lightning }},
    %{id: 1032, name: "Lightning Staff 2", value: 2, type: :weapon, specifically: %{kind: :weapon_staff, atk: 4,  range: 2, elem: :elem_lightning }},
    %{id: 1033, name: "Lightning Staff 3", value: 3, type: :weapon, specifically: %{kind: :weapon_staff, atk: 8,  range: 2, elem: :elem_lightning }},
    %{id: 1034, name: "Lightning Staff 4", value: 4, type: :weapon, specifically: %{kind: :weapon_staff, atk: 10,  range: 3, elem: :elem_lightning }},
    %{id: 1035, name: "Lightning Staff 5", value: 5, type: :weapon, specifically: %{kind: :weapon_staff, atk: 11, range: 5, elem: :elem_lightning }},
    %{id: 1031, name: "Healing Staff 1", value: 1, type: :weapon, specifically: %{kind: :weapon_staff, heal: 3, atk: 1, range: 1, elem: :elem_healing }},
    %{id: 1032, name: "Healing Staff 2", value: 2, type: :weapon, specifically: %{kind: :weapon_staff, heal: 5, atk: 2, range: 1, elem: :elem_healing }},
    %{id: 1033, name: "Healing Staff 3", value: 3, type: :weapon, specifically: %{kind: :weapon_staff, heal: 7, atk: 3, range: 2, elem: :elem_healing }},
    %{id: 1034, name: "Healing Staff 4", value: 4, type: :weapon, specifically: %{kind: :weapon_staff, heal: 9, atk: 4, range: 2, elem: :elem_healing }},
    %{id: 1035, name: "Healing Staff 5", value: 5, type: :weapon, specifically: %{kind: :weapon_staff, heal: 6, atk: 5, range: 3, area: 2, elem: :elem_healing }},
